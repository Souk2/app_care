...
class ophtamologyScreen extends StatefulWidget {
  ...
  @override
  State<ophtamologyScreen> createState() => _DoctorListScreenState();
}

class _DoctorListScreenState extends State<ophtamologyScreen> {
