...
class gynecologyScreen extends StatefulWidget {
  ...
  @override
  State<gynecologyScreen> createState() => _DoctorListScreenState();
}

class _DoctorListScreenState extends State<gynecologyScreen> {
