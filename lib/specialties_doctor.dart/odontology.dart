...
class odontologyScreen extends StatefulWidget {
  ...
  @override
  State<odontologyScreen> createState() => _DoctorListScreenState();
}

class _DoctorListScreenState extends State<odontologyScreen> {
  ...
  final List<Map<String, dynamic>> _doctors = [
    {
      'name': 'Dr. Dylan Lewis, M.D.',
      'specialty': 'Endodontics',
      'image': 'assets/images/doctor1.jpg',
      'isFavorite': false,
    },
    {
      'name': 'Dr. Hazel Mitchell, M.D.',
    ...
    {
      'name': 'Dr. Joseph Green, M.D.',
      'specialty': 'Special Care Dentistry',
